...
public class BasicQueueWork {
  ...
  private long srvPj;
  private long preSrvGroupId;
  private long preSrvCodeId;
  private long preWsId;
  private long preStaffId;
  private String preStaffCode;
  ...
  public long getSrvCodeId() {
    return srvCodeId;
  }

  public void setSrvCodeId(long srvCodeId) {
    this.srvCodeId = srvCodeId;
  }
  ...
  public void setNextTime(java.sql.Timestamp nextTime) {
  ...
  public java.sql.Timestamp getStampTime() {
    return stampTime;
  }

  public void setStampTime(java.sql.Timestamp stampTime) {
  ...
  public long getSrvPj() {
    return srvPj;
  }

  public void setSrvPj(long srvPj) {
    this.srvPj = srvPj;
  }


  public long getPreSrvGroupId() {
    return preSrvGroupId;
  }

  public void setPreSrvGroupId(long preSrvGroupId) {
    this.preSrvGroupId = preSrvGroupId;
  }


  public long getPreSrvCodeId() {
    return preSrvCodeId;
  }

  public void setPreSrvCodeId(long preSrvCodeId) {
    this.preSrvCodeId = preSrvCodeId;
  }


  public long getPreWsId() {
    return preWsId;
  }

  public void setPreWsId(long preWsId) {
    this.preWsId = preWsId;
  }


  public long getPreStaffId() {
    return preStaffId;
  }

  public void setPreStaffId(long preStaffId) {
    this.preStaffId = preStaffId;
  }


  public String getPreStaffCode() {
    return preStaffCode;
  }

  public void setPreStaffCode(String preStaffCode) {
    this.preStaffCode = preStaffCode;
  }
